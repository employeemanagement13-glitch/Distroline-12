-- Migration v45: Fix bank_account_ledger view for Sell In Payments amount calculation
...
SELECT
  si.tenant_id,
  si.bank_account_id,
  COALESCE(si.income_date, si.income_month::DATE)   AS txn_date,
  'Incentive'::TEXT                                 AS txn_type,
  COALESCE(si.description, 'Scheme Income')         AS reference,
