-- ============================================================================
-- MDOS v30 — Empty Ledger View & RPC Function
--
-- Directions:
--   1. Shop → Distribution (from invoice_returns)
--   2. Distribution → CCBPL (from sell_in_arrived_lines returned_qty)
-- ============================================================================
...
-- 2. Distribution → CCBPL (from sell_in_arrived_lines)
SELECT
  sal.tenant_id,
...
SELECT
  ...
  qty,
  SUM(
    CASE WHEN direction = 'Shop → Distribution' THEN qty ELSE -qty END
  ) OVER (
